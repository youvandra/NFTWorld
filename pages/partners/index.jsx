...
const Partners = () => {
	return (
		<div>
			<Meta title="Partners || NFT World | NFT Marketplace Next.js Template" />
					...
					<div className="container">
						<div className="mx-auto max-w-xl text-center">
							<h1 className="font-display text-jacarta-700 mb-6 text-center text-4xl font-medium dark:text-white">
								NFT World Affiliate Partnership
							</h1>
							<p className="dark:text-jacarta-200 mb-16 text-lg leading-normal">
								Interested in making money with NFT World? Earn A 20% Commission For Every Sale You
						...
						<div className="dark:bg-jacarta-700 rounded-2.5xl flex flex-wrap bg-white p-10 md:flex-nowrap md:space-x-8 md:p-[4.25rem] lg:space-x-16">
							...
							<div className="mb-4 md:mb-0">
								<p className="text-jacarta-700 text-lg leading-normal dark:text-white">
									{
										"NFT World is one of the most exciting, important companies in the world right now because it's the portal to the new digital economy. If you're interested in shaping a new business model for creators, this is the team to join."
									}
								</p>
					...
					<div className="container">
						<div className="mx-auto max-w-2xl text-center">
							...
							<p className="mb-10 text-lg leading-normal text-white">
								...
								drops, and tips and tricks for navigating NFT World
							</p>
							<Link href="/contact">
