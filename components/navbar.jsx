						...
						<div className="flex items-center px-6 py-6 xl:px-24 ">
							...
							<Link href="/">
								<a className="shrink-0 block dark:hidden">
									<img src="https://i.ibb.co/4pY6n2W/NFT-WORLD.png" alt="" className="max-h-7 h-auto" />
								</a>
							</Link>
							<Link href="/">
							...
							{home3 ? (
								<Link href="/">
									<a className="shrink-0">
										{/* <img src="https://i.ibb.co/4pY6n2W/NFT-WORLD.png" alt="" className="max-h-7 h-auto dark:hidden" /> */}
